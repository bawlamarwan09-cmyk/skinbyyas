...
export default async function Page({params}:{params:Promise<{slug:string}>}){const{slug}=await params;return <main><CommerceHeader/><BrandPage slug={slug}/><CommerceFooter/></main>}
