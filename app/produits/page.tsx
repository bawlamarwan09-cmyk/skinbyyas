...
export default function Page(){ return <CommercePage eyebrow="BOUTIQUE EN LIGNE" title="Tous nos produits" intro="Explorez les produits disponibles chez Skin by Yas et découvrez notre sélection skincare, cheveux, corps et solaire."/>; }
