...
export default function Page(){ return <CommercePage eyebrow="SKIN BY YAS — AGADIR" title="Soins Corps à Agadir" intro="Explorez notre sélection de produits pour les soins du corps disponibles chez Skin by Yas."/>; }
