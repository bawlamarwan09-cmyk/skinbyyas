...
export default function Page(){ return <CommercePage eyebrow="SKIN BY YAS — AGADIR" title="Soins Cheveux à Agadir" intro="Découvrez notre sélection de produits dédiés aux soins des cheveux et retrouvez les références disponibles chez Skin by Yas."><CatalogProducts category="soins-cheveux"/></CommercePage>; }
